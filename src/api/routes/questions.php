...
$app->get('/formsubmit/{groupid}/{IZ1}/{IZ2}/{IZ3}/{IW1}/{IW2}/{IW3}/{IWE1}/{IWE2}/{IWE3}/{IWE4}/{IK1}/{IK2}/{IK3}/{SMOE1}/{SMOE2}/{SMOE3}/{SMOE4}/{SMOE5}/{SMOE6}/{SMOE7}', function (Request $request, Response $response) {
    // what key
...
// TODO: adjust the normal ones to the new group, probably make it a post with a proper body. Parameters links will get messy
$app->get('/checklistsubmit/{groupid}/{CW1}/{CW2}/{VB1}/{VB2}/{VB3}/{OPL1}/{OPL2}/{OPL3}/{PRO1}/{PRO2}/{PRO3}/{COM1}/{COM2}/{COM3}/{BOR1}/{BOR2}/{BOR3}/{BOR4}', function (Request $request, Response $response) {
    // what key
    $groupid = $request->getAttribute('groupid');
    $groupid = (int)$groupid;
